  ...
  <section class="py-16 bg-white">
    <div class="container mx-auto px-6 max-w-5xl">
      <div class="flex flex-col md:flex-row items-center gap-10">
        <div class="md:w-1/2">
          <img src="img/biji.jpeg" alt="Sejarah Kopi Vintage" class="rounded-lg shadow-lg w-full h-auto">
        </div>
        <div class="md:w-1/2">
  ...
  <section class="py-16 bg-yellow-100">
    <div class="container mx-auto px-6 max-w-5xl">
      <div class="flex flex-col md:flex-row-reverse items-center gap-10">
        <div class="md:w-1/2">
          <img src="img/fk.jpeg" alt="Filosofi Kopi Vintage" class="rounded-lg shadow-lg w-full h-auto">
        </div>
        <div class="md:w-1/2">
    ...
    <div class="container mx-auto px-6">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div class="tim-card bg-white border border-yellow-200 rounded-lg overflow-hidden shadow-md transition duration-300">
          <img src="img/kucing.jpeg" alt="Andi Wijaya" class="w-full h-64 object-cover">
          <div class="p-6">
            <h4 class="font-bold text-xl mb-1">muhammad zainul ichsan</h4>
            <p class="text-yellow-600 font-medium mb-3">ketua</p>
            <p class="text-gray-600">06.2023.1.07647</p>
          </div>
        </div>
        
        <!-- Anggota Tim 2 -->
        <div class="tim-card bg-white border border-yellow-200 rounded-lg overflow-hidden shadow-md transition duration-300">
          <img src="img/kucing.jpeg" alt="Siti Rahayu" class="w-full h-64 object-cover">
          <div class="p-6">
            <h4 class="font-bold text-xl mb-1">Siti Rahayu</h4>
            <p class="text-yellow-600 font-medium mb-3">anggota</p>
        ...
        <!-- Anggota Tim 3 -->
        <div class="tim-card bg-white border border-yellow-200 rounded-lg overflow-hidden shadow-md transition duration-300">
          <img src="img/kucing.jpeg" alt="Budi Santoso" class="w-full h-64 object-cover">
          <div class="p-6">
            <h4 class="font-bold text-xl mb-1">bima wahyu burhanuddin</h4>
            <p class="text-yellow-600 font-medium mb-3">anggota</p>
            <p class="text-gray-600">06.2023.1.07648</p>
          </div>
        </div>
      </div>
    </div>
